...
export default {
  ...
  props: {
    ...
    primaryKey: {
      type: String,
      default: task.primaryKey || 'id',
    },
    activeColumnName: {
      type: String,
      default: task.activityColumnName || 'active',
    },
    mode: {
      type: String,
      validator (value) {
    ...
    createMode: {
      type: Boolean,
      default: task.createMode === undefined ? true : task.createMode,
    },
    editMode: {
      type: Boolean,
      default: task.editMode === undefined ? true : task.editMode,
    },
    mainFilter: {
      type: Boolean,
      default: task.mainFilter === undefined ? true : task.mainFilter,
    },
    fieldFilters: {
      type: Boolean,
      default: task.fieldFilters === undefined ? true : task.fieldFilters,
    },
    exportButton: {
      type: Boolean,
      default: task.exportButton === undefined ? true : task.exportButton,
    },
    refreshButton: {
      type: Boolean,
      default: task.refreshButton === undefined ? true : task.refreshButton,
    },
    selectManyMode: {
      type: Boolean,
      default: task.selectManyMode === undefined ? true : task.selectManyMode,
    },
    updateManyMode: {
      type: Boolean,
      default: task.updateManyMode === undefined ? true : task.updateManyMode,
    },
    removeManyMode: {
      type: Boolean,
      default: task.removeManyMode === undefined ? true : task.removeManyMode,
    },
    itemDetailsWidth: {
      default: 600,
    },
  ...
  computed: {
    ...
    componentLoader () {
      ...
      return () => import(`./Task${typeNamePart}${modeNamePart}.vue`)
    },
  },
  methods: {
    ...
    ...mapActions('task', ['runItemsViewRefreshing']),
